...
export default function Home() {
  return (
    <section>
      ...
      <p>Welcome to my UI submission! This layout should adhere to the guidelines in the Figma mockup perfectly!</p> 
      ...
      <p>The complete requested layout is located <Link href="attendees/attendees">here</Link></p>
    </section>
  );
}
